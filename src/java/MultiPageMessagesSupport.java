 ...
 *
 * @version This version have the bug corrected: The bug was: In the same page,
 * the FacesMessage was displayed many times, with this patch, only different
 * messages is added into new context.
 */
